...
namespace AirportWeatherPro.WeatherService {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface GlobalWeatherSoapChannel : AirportWeatherPro.WeatherService.GlobalWeatherSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GlobalWeatherSoapClient : System.ServiceModel.ClientBase<AirportWeatherPro.WeatherService.GlobalWeatherSoap>, AirportWeatherPro.WeatherService.GlobalWeatherSoap {
        ...
        System.IAsyncResult AirportWeatherPro.WeatherService.GlobalWeatherSoap.BeginGetWeather(string CityName, string CountryName, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetWeather(CityName, CountryName, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string AirportWeatherPro.WeatherService.GlobalWeatherSoap.EndGetWeather(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetWeather(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((AirportWeatherPro.WeatherService.GlobalWeatherSoap)(this)).BeginGetWeather(CityName, CountryName, callback, asyncState);
        }
        
        private object[] OnEndGetWeather(System.IAsyncResult result) {
            string retVal = ((AirportWeatherPro.WeatherService.GlobalWeatherSoap)(this)).EndGetWeather(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult AirportWeatherPro.WeatherService.GlobalWeatherSoap.BeginGetCitiesByCountry(string CountryName, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetCitiesByCountry(CountryName, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string AirportWeatherPro.WeatherService.GlobalWeatherSoap.EndGetCitiesByCountry(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetCitiesByCountry(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((AirportWeatherPro.WeatherService.GlobalWeatherSoap)(this)).BeginGetCitiesByCountry(CountryName, callback, asyncState);
        }
        
        private object[] OnEndGetCitiesByCountry(System.IAsyncResult result) {
            string retVal = ((AirportWeatherPro.WeatherService.GlobalWeatherSoap)(this)).EndGetCitiesByCountry(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override AirportWeatherPro.WeatherService.GlobalWeatherSoap CreateChannel() {
            return new GlobalWeatherSoapClientChannel(this);
        }
        
        private class GlobalWeatherSoapClientChannel : ChannelBase<AirportWeatherPro.WeatherService.GlobalWeatherSoap>, AirportWeatherPro.WeatherService.GlobalWeatherSoap {
            
            public GlobalWeatherSoapClientChannel(System.ServiceModel.ClientBase<AirportWeatherPro.WeatherService.GlobalWeatherSoap> client) : 
                    base(client) {
            }
