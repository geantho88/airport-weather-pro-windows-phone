...
namespace AkazooProject.ResourcesAccessLogic
{
    public class MultimediaLoad
    {
        ...
        public static BitmapImage LoadPngImage(string name)
        {
            try
            {
                ...
                {
                    Uri uri = new Uri("/AirportWeatherPro;component/Images/noimage.png", UriKind.Relative);
                    BitmapImage imgSource = new BitmapImage(uri);
                    return imgSource;
                }
                else
                {
                    Uri uri = new Uri("/AirportWeatherPro;component/Images/"+ name + ".png", UriKind.Relative);
                    BitmapImage imgSource = new BitmapImage(uri);
                    return imgSource;
                }
            }
        ...
        public static BitmapImage LoadJpgImage(string name)
        {
            try
            {
                ...
                {
                    Uri uri = new Uri("/AirportWeatherPro;component/Images/" + name + ".jpg", UriKind.Relative);
                    BitmapImage imgSource = new BitmapImage(uri);
                    return imgSource;
                }
            }
        ...
        {
            Uri uri = new Uri("/AirportWeatherPro;component/Images/" + frame + ".png", UriKind.Relative);
            BitmapImage imgSource = new BitmapImage(uri);
            return imgSource;
        }
        ...
        public static ImageBrush  LoadBackground(string name)
        {
            try
            {
                BitmapImage bitmapImage = new BitmapImage(new Uri("/AirportWeatherPro;component/Images/" + name + ".png", UriKind.Relative));
        ...
        public static StackPanel  LoadButtonBackround(string name)
        {
            try
            {
                Uri dir = new Uri("/AirportWeatherPro;component/Images/" + name + ".png", UriKind.Relative);
